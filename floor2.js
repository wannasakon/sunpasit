...
const getTasks = () => db.collection("floor2").get();

const onGetTasks = (callback) => db.collection("floor2").onSnapshot(callback);

const deleteTask = (id) => db.collection("floor2").doc(id).delete();

const getTask = (id) => db.collection("floor2").doc(id).get();

const updateTask = (id, updatedTask) => db.collection('floor2').doc(id).update(updatedTask);
